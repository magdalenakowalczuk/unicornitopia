...
class UnicornsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create unicorn" do
    assert_difference('Unicorn.count') do
      post unicorns_url, params: { unicorn: { magical: @unicorn.magical, name: @unicorn.name, source: @unicorn.source, year: @unicorn.year } }
    end
  ...
  test "should update unicorn" do
    patch unicorn_url(@unicorn), params: { unicorn: { magical: @unicorn.magical, name: @unicorn.name, source: @unicorn.source, year: @unicorn.year } }
